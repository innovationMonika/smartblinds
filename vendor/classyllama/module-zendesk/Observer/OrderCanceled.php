...
class OrderCanceled extends Base
{
    ...
    protected function getSunshineEvent()
    {
        try {
            ...
            $this->getShippingAddressArray()
                ? $payload['profile']['attributes']['address'] = $this->getShippingAddressArray() : null;
            $this->getShippingAddressArray()
                ? $payload['event']['properties']['shipping address'] = $this->getShippingAddressArray() : null;
