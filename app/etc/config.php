...
return [
    'modules' => [
        ...
        'Amasty_ShopbyPage' => 1,
        'Amasty_GroupedOptionsRewrite' => 1,
        'Ananta_ImprovedCheckout' => 1,
        'Anowave_Package' => 1,
        'Anowave_Ec' => 1,
        'Anowave_Ec4' => 1,
        ...
        'GoMage_Addons' => 1,
        'GoMage_AmastyGroupedOptions' => 1,
        'GoMage_AmastyShopbyFix' => 1,
        'GoMage_BaseSuggestions' => 1,
        'GoMage_Breadcrumbs' => 1,
        'GoMage_Catalog' => 1,
        'GoMage_CatalogBlocks' => 1,
        'GoMage_CatalogDiscountLabels' => 1,
        'GoMage_Checkout' => 1,
        'GoMage_Config' => 1,
        'GoMage_Cookiebot' => 1,
        'GoMage_Coupon' => 1,
        ...
        'GoMage_Samples' => 1,
        'GoMage_Erp' => 1,
        'GoMage_ErpOrderExport' => 1,
        'Magefan_Community' => 1,
        'GoMage_PaidCustomerGroup' => 1,
        'Plumrocket_Base' => 1,
        'Smartblinds_ConfigurableProduct' => 1,
        'GoMage_SamplesCategory' => 1,
        'GoMage_Ui' => 1,
        'GoMage_UpdateCartAjax' => 1,
        'GoMage_Xsl' => 1,
        'Klaviyo_Reclaim' => 1,
        'MageSuite_Magepack' => 1,
        'MageWorx_OptionBase' => 1,
        'MageWorx_Info' => 1,
        'MageWorx_MultiFees' => 0,
        ...
        'Magefan_AlternateHreflang' => 1,
        'Magefan_Blog' => 1,
        'Magefan_BlogGraphQl' => 1,
        'GoMage_MagefanBlog' => 1,
        'Magefan_Crowdin' => 1,
        'Magefan_LazyLoad' => 1,
        ...
        'Mageplaza_SpecialPromotions' => 1,
        'Mageside_PageHierarchy' => 1,
        'Magetrend_PdfTemplates' => 1,
        'Magmodules_Channable' => 1,
        'Magmodules_RichSnippets' => 1,
        'Magmodules_Schema' => 1,
        'Meetanshi_Totalsaving' => 1,
        'Mollie_Payment' => 1,
        'MyParcelNL_Magento' => 0,
        'PayPal_Braintree' => 1,
        'PayPal_BraintreeGraphQl' => 1,
        'Paynl_Payment' => 1,
        'Plumrocket_Search' => 1,
        'GoMage_PlumrocketSearch' => 1,
        'Smartblinds_AddToCart' => 1,
        'Smartblinds_AdminActions' => 1,
        'Smartblinds_AjaxInfiniteScroll' => 1,
        'Smartblinds_Checkout' => 1,
        'Smartblinds_Blog' => 1,
        'Smartblinds_Bundling' => 0,
        'Smartblinds_Catalog' => 1,
        'Smartblinds_CatalogSearch' => 1,
        'Smartblinds_Config' => 1,
        'Smartblinds_Cms' => 1,
        'Smartblinds_CmsPdf' => 1,
        'Smartblinds_AutoInvoice' => 1,
        'GoMage_Ec' => 1,
        'Smartblinds_ConfigurableSimple' => 1,
        'Smartblinds_Conversions' => 1,
        'WeltPixel_Backend' => 1,
        'Smartblinds_Customer' => 1,
        'Smartblinds_Eav' => 1,
        'Smartblinds_Ec' => 1,
        'Smartblinds_Elasticsearch' => 1,
        'Smartblinds_Framework' => 1,
        'Smartblinds_ImageImport' => 1,
        'Smartblinds_LazyLoad' => 1,
        'Smartblinds_Magepack' => 1,
        'Smartblinds_MediaStorage' => 1,
        'Smartblinds_Mollie' => 1,
        'Smartblinds_MultiFees' => 0,
        'Smartblinds_Newsletter' => 1,
        'Smartblinds_Options' => 1,
        'Smartblinds_OrderStatus' => 1,
        'Smartblinds_PageHierarchy' => 1,
        'TIG_PostNL' => 1,
        'Smartblinds_PreloadLinks' => 1,
        'Smartblinds_Redirect' => 1,
        'Smartblinds_RequireJs' => 1,
        'Smartblinds_Sales' => 1,
        'Smartblinds_Security' => 1,
        'Smartblinds_Shipping' => 1,
        'Smartblinds_Shopby' => 1,
        'Smartblinds_Sitemap' => 1,
        'Smartblinds_Swatches' => 1,
        'Smartblinds_System' => 1,
        'Smartblinds_Tax' => 1,
        'Smartblinds_Theme' => 1,
        'Smartblinds_TwoFactorAuth' => 1,
        'Smartblinds_WebP' => 1,
        'Smartblinds_Zendesk' => 1,
        'Smartblinds_PostNL' => 1,
