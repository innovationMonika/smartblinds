 ...
 */
namespace Smartblinds\Options\Helper\Product;
        ...
        if (is_array($optionValue)) {
            if (isset($optionValue['option_id'])) {
                $optionInfo = $optionValue;
                   ...
                   if(isset($optionInfo['option_type']) && $optionInfo['option_type'] == 'width_height'){
                        $jsonArray = json_decode($optionInfo['value'], true);
                          // Remove unwanted keys
                        if(isset($jsonArray['matchwidth']) && isset($jsonArray['matchheight']) && isset($jsonArray['matchm2'])){
                            unset($jsonArray['matchwidth'], $jsonArray['matchheight'], $jsonArray['matchm2']);
                               // Convert back to JSON
                            $optionValue = json_encode($jsonArray);
