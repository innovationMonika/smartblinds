...
use Smartblinds\Options\Model\Attribute\Option\OptionCode;

class Code extends AbstractModifier implements ModifierInterface
{
    private $meta = [];
    ...
    protected function addSetting()
    {
        ...
        $fields = [OptionCode::CODE => $this->getFieldConfig()];
