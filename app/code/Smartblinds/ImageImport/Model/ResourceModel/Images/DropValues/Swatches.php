...
class Swatches implements ExecutorInterface
{
    ...
    public function loadValuesToDelete(): array
    {
        ...
        $select = $connection->select()
            ...
            ->where('cpev.attribute_id = ?', $swatchImageAttribute->getAttributeId())
            ->where('cpe.sku IN (?)', $this->skuLoader->loadSkus('swatches'));
