...
/**
 * Class NewProductYActionHtml
 * @package Mageplaza\SpecialPromotions\Controller\Adminhtml\Promo\Quote
 */
class NewProductYActionHtml extends NewProductActionHtml
{
    /**
    ...
    {
        $this->setBodyResponse('mp_product_y_actions', 'product_y_rule_actions_fieldset_');
    }
}
