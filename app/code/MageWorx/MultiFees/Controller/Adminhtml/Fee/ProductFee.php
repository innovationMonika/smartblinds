...
use MageWorx\MultiFees\Model\ProductFeeFactory as FeeFactory;
use MageWorx\MultiFees\Api\ProductFeeRepositoryInterface as FeeRepository;
use Magento\Framework\Registry;
use Magento\Framework\View\Result\PageFactory;
use Magento\Framework\Controller\Result\JsonFactory;

abstract class ProductFee extends Action
{
    /**
    ...
    /**
     * @return \MageWorx\MultiFees\Model\ProductFee
    ...
    protected function initAction()
    {
        ...
        $resultPage->getConfig()->getTitle()->prepend((__('Product Fee')));
        $resultPage->addBreadcrumb(__('MultiFees'), __('MultiFees'));
        $resultPage->addBreadcrumb(__('Product Fee'), __('Product Fee'));
