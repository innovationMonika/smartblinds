...
class FeeDetailsPlugin
{
    ...
    public function __construct(
        ...
        $this->codes                        = ['mageworx_fee', 'mageworx_product_fee'];
    }
    ...
    protected function getOptionsData($options, $code)
    {
        ...
        foreach ($options as $option) {
            ...
            if ($code == 'mageworx_fee') {
                $feeOption->setPrice($option['price']);
            } else {
                $feeOption->setPrice($option['price'] - $option['tax']);
            }
