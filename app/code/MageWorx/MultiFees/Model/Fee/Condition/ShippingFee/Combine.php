 ...
 * Class Combine
 *
 * @package MageWorx\MultiFees\Model\Fee\Condition\ShippingFee
 *
...
class Combine extends \Magento\Rule\Model\Condition\Combine
{
    ...
    public function __construct(
        ...
        \MageWorx\MultiFees\Model\Fee\Condition\ShippingFee\Address $conditionAddress,
        array $data = []
    ) {
        $this->eventManager     = $eventManager;
        $this->conditionAddress = $conditionAddress;
        parent::__construct($context, $data);
        $this->setType('MageWorx\MultiFees\Model\Fee\Condition\ShippingFee\Combine');
    }
    ...
    public function getNewChildSelectOptions()
    {
        ...
        foreach ($addressAttributes as $code => $label) {
            $attributes[] = [
                'value' => 'MageWorx\MultiFees\Model\Fee\Condition\ShippingFee\Address|' . $code,
                'label' => $label,
            ];
        }
        ...
        $conditions = array_merge_recursive(
            ...
            [
                ...
                [
                    'value' => 'MageWorx\MultiFees\Model\Fee\Condition\ShippingFee\Combine',
        ...
        $this->eventManager->dispatch('mageworx_shipping_fee_condition_combine', ['additional' => $additional]);
