...
class ProductFeeCollection extends AbstractCollection
{
    const FEE_MODEL_CLASS_NAME          = 'MageWorx\MultiFees\Model\ProductFee';
    const FEE_RESOURCE_MODEL_CLASS_NAME = 'MageWorx\MultiFees\Model\ResourceModel\ProductFeeResource';
    ...
    protected function addFeeTypeFilter()
    {
        ...
        $this->getSelect()
             ->where('`main_table`.`' . FeeInterface::TYPE . '` = ?', FeeInterface::PRODUCT_TYPE);
