...
class Conditions extends OriginalConditions
{
    ...
    protected function _prepareForm()
    {
        ...
        $renderer = $this->rendererFieldset->setTemplate(
            ...
            $this->getUrl('mageworx_multifees/fee_payment/newConditionHtml/form/rule_conditions_fieldset')
        )->setNameInLayout('mageworx_multifees_payment_catalog_rule_renderer');
