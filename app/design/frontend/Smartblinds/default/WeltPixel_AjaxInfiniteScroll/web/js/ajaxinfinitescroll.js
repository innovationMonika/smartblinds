            ...
            initInfiniteScroll: function ()
            {
                jQuery(function($) {
                    ...
                    ias.getNextUrl = function(container) {
                        ...
                        nexturl = window.ajaxInfiniteScroll.removeQueryStringParameter('isAjax', nexturl);
                        return nexturl;
                    };
                    ...
                    ias.extension(new IAS.IASPagingExtension());
                    ...
                    ias.extension(new IAS.IASNoneLeftExtension({
                    ...
                    loadingHtml += '</div>';
                    ias.extension(new IAS.IASSpinnerExtension({
                    ...
                    if (window.LoadMore > 0) {
                        ias.extension(new IAS.IASTriggerExtension({
                    ...
                    ias.extension(new IAS.IASHistoryExtension({prev: '.previous'}));
